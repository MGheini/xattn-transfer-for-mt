...
def add_transformer_body_loading_args(parser):
    ...
    group.add_argument('--only-finetune-cross-attn', action='store_true',
                       help='freeze all body parameters but the cross attention')
    group.add_argument('--load-model-but-src-embeddings-and-freeze-tgt-embeddings-from', default=None, type=str,
